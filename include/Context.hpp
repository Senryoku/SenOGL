...
inline void drawArrays(Primitive primitiveType, size_t first, size_t count);
inline void drawElements(Primitive primitiveType, size_t count,
                         IndexType indexType, void *indices = nullptr);
...
inline void safeCheck(std::function<void()> func,
