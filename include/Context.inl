...
inline void Context::enable(Capability c) { glEnable(to_underlying(c)); }

inline void Context::enable(Capability c, size_t i) {
  glEnablei(to_underlying(c), static_cast<GLuint>(i));
}

inline void Context::disable(Capability c) { glDisable(to_underlying(c)); }
...
inline void Context::clear(BufferBit bb) { glClear(to_underlying(bb)); }
...
inline void Context::drawArrays(Primitive primitiveType, size_t first,
                                size_t count) {
  glDrawArrays(to_underlying(primitiveType), static_cast<GLint>(first),
               static_cast<GLsizei>(count));
}

inline void Context::drawElements(Primitive primitiveType, size_t count,
                                  IndexType indexType, void *indices) {
  glDrawElements(to_underlying(primitiveType), count, to_underlying(indexType),
                 indices);
}

inline void Context::clearError() { glGetError(); }
...
inline void Context::safeCheck(std::function<void()> func,
